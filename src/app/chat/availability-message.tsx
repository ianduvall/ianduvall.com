...
const availabilityPromise =
	typeof LanguageModel !== "undefined" && LanguageModel.availability(languageModelCreateOptions);

export default function Message({ action }: { action?: () => void }) {
	const availability = availabilityPromise ? use(availabilityPromise) : "unavailable";
				...
				<div>
					...
					<Link
						...
						onClick={(event) => {
							...
							void navigator.clipboard.writeText("chrome://flags/#prompt-api-for-gemini-nano");
